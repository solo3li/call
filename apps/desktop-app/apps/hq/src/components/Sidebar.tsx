...
const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ai-settings", label: "الذكاء الاصطناعي والمكالمات", icon: MessageSquare, color: "bg-brand-orange text-white", restricted: true },
      { id: "external-companies", label: "شركات التوصيل", icon: Store, color: "bg-[#FF6B35] text-white", restricted: true },
      { id: "helpdesk", label: "الدعم الفني للمنصة", icon: LifeBuoy, color: "bg-[#FF6B35] text-white" }
    ]
  }
];
