...
export const ReceiptTemplate: React.FC<ReceiptProps> = ({
  ...
  return (
    <div className="receipt p-4 max-w-xs mx-auto border-2 border-black font-mono text-sm bg-white text-black">
      ...
      {externalCompanyName && (
        <div className="mb-2 p-1 border border-dashed border-gray-400">
          <div><strong>App:</strong> {externalCompanyName}</div>
          {externalOrderId && <div><strong>Ext ID:</strong> {externalOrderId}</div>}
        </div>
      )}

      <div className="border-t-2 border-black py-2 my-2">
