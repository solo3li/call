...
export const getBaseUrl = () => {
  ...
  // For Tauri or static export, use absolute URL pointing to the remote backend ingress
  return 'https://167.71.66.188.nip.io';
};
...
export const dashboardApi = {
  getStats: (branchId?: string) => api.get<DashboardStats>('/dashboard/stats', branchId ? { params: { branchId } } : undefined),
};
