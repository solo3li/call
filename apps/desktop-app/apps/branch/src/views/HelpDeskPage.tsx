        ...
        {/* LOBBY VIEW */}
            ...
            {activeView === 'chat' && (
              <>
                ...
                <div className="bg-white p-2 border-t-2 border-[#1A1A1A] relative">
                  {isRecording ? (
                    <div className="flex items-center justify-between w-full h-8 bg-[#FFFBEB] border-2 border-[#1A1A1A] px-1 shadow-sm">
                      <button 
                        aria-label="Discard recording"
                        onClick={() => stopRecording(false)} 
                        className="p-1 text-[#1A1A1A] hover:bg-red-500 hover:text-white transition"
                      >
                      ...
                      <button 
                        ...
                        className="p-1 bg-[#00E676] text-[#1A1A1A] border-2 border-[#1A1A1A] shadow-sm transition"
                      >
                    ...
                    <form onSubmit={sendMessage} className="flex items-end gap-1">
                      ...
                      <div className="flex gap-1">
                        <button 
                          ...
                          className="p-1 text-[#1A1A1A] bg-[#FFD700] border-2 border-[#1A1A1A] shadow-sm transition flex-shrink-0"
                        >
                        ...
                        <button 
                          ...
                          className="p-1 text-[#1A1A1A] bg-[#FF69B4] border-2 border-[#1A1A1A] shadow-sm transition flex-shrink-0"
                        >
                      ...
                      <button 
                        ...
                        className="p-1 bg-[#FF6B35] text-[#1A1A1A] border-2 border-[#1A1A1A] shadow-sm disabled:opacity-50 transition-all flex-shrink-0"
                      >
