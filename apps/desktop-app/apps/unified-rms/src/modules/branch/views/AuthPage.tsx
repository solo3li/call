...
export default function AuthPage({ isLogin = true }: { isLogin?: boolean }) {
 ...
 return (
 <div className="min-h-screen w-full flex items-center justify-center bg-carbon-layerHover font-cairo py-12 relative overflow-hidden" dir="rtl">
 ...
 <Link href="/" className="absolute top-6 right-6 z-20 flex items-center gap-2 px-5 py-2.5 bg-carbon-layer border-carbon-border rounded-sm font-semibold text-[#1A1A1A] hover: active: transition-all text-sm">
 ...
 <div className="absolute inset-0 bg-[#FFD700] border-carbon-border rounded-[28px] translate-x-3 translate-y-3 -rotate-1 z-0"></div>
 
 {/* Main Content Ledger Card */}
 <div className="relative z-10 bg-carbon-layer border-carbon-border rounded-[28px] p-8 md:p-10 shadow-none">
 ...
 />
 <h1 className="text-4xl font-semibold bg-[#FF6B35] text-white px-6 py-2 border-carbon-border rotate-1 inline-block rounded-sm tracking-tight">
 أوبنو
 </h1>
 ...
 {error && (
 <div className="mb-4">
 <div className="p-4 bg-[#FF1744] text-white border-carbon-border rounded-sm font-semibold text-sm text-center flex items-center justify-center gap-2 rotate-[-1deg]">
 {error}
 </div>
 </div>
 )}
 ...
 {success && (
 <div className="mb-6 p-4 bg-[#00E676] text-[#1A1A1A] border-carbon-border rounded-sm font-semibold text-sm text-center flex flex-col items-center justify-center gap-2 ">
 ...
 <div className="bg-carbon-layerHover border-carbon-border rounded-sm p-4 flex gap-4 items-start ">
 <div className="w-12 h-12 bg-[#AA00FF]/15 border-[#AA00FF] rounded-sm flex items-center justify-center shrink-0">
 ...
 <div className="relative flex items-center border-carbon-border rounded-sm overflow-hidden focus-within: focus-within:translate-y-[-1px] transition-all">
 <div className="absolute right-0 top-0 bottom-0 w-12 bg-[#AA00FF]/10 border-l-3 border-carbon-border flex items-center justify-center rounded-r-lg">
 ...
 className="w-full pr-16 pl-4 py-4 text-2xl tracking-[0.2em] font-semibold dir-ltr text-center uppercase bg-carbon-layer text-[#1A1A1A] focus:outline-none placeholder-gray-300"
 />
 </div>
 ...
 type="submit"
 disabled={loading || success}
 className="w-full py-4 text-xl flex items-center justify-center gap-3 border-carbon-border rounded-sm font-semibold hover: active: transition-all text-white bg-[#AA00FF] "
 >
 {loading ? (
