...
export default function WeeklyRatings() {
 ...
 <div className="flex items-center gap-1.5">
 <div className="w-3 h-3 bg-carbon-layer rounded border-carbon-border"></div>
 <span className="text-xs font-medium">جيد (4.5+)</span>
 </div>
 <div className="flex items-center gap-1.5">
 <div className="w-3 h-3 bg-carbon-warning/10 text-carbon-warning rounded border-carbon-border"></div>
