...
export default function StatsCards({ stats }: StatsCardsProps) {
 ...
 trend: "up",
 icon: DollarSign,
 color: "bg-carbon-success/10 text-carbon-success",
 emoji: "",
 },
 {
 title: "الطلبات",
 ...
 trend: "up",
 icon: ShoppingBag,
 color: "bg-carbon-warning/10 text-carbon-warning",
 emoji: "",
 },
 ...
 if (!mounted) return <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 h-32 animate-pulse bg-carbon-layer border-carbon-border"></div>;
 ...
 <div
 key={index}
 className="bg-carbon-layer border-carbon-border p-5 relative"
 >
