...
export default function LiveStatus() {
 ...
 { label: "في المطبخ", count: stats?.inKitchenOrders || 0, icon: ChefHat, color: "bg-carbon-blue text-white", emoji: "" },
 { label: "قيد التوصيل", count: stats?.deliveryOrders || 0, icon: Truck, color: "bg-[#8a3ffc] text-white", emoji: "" },
 { label: "مكتملة اليوم", count: stats?.completedTodayOrders || 0, icon: CheckCircle2, color: "bg-carbon-success text-white", emoji: "" },
 ];

 return (
 <div className="bg-carbon-layer border-carbon-border p-5">
 <div className="flex items-center gap-2 mb-4">
 <div className="w-3 h-3 bg-carbon-error rounded-full animate-pulse-glow"></div>
 <h3 className="font-medium text-lg text-white">البث المباشر</h3>
 <span className="bg-carbon-error text-white text-[10px] font-medium px-2 py-0.5 ml-2">LIVE</span>
 </div>
 ...
 <p className="text-3xl font-medium">{stat.count}</p>
