...
export default function DeliveryDashboard() {
 ...
 // Global Status Logic
 let globalStatus = { text: "توصيل طبيعي", color: "bg-carbon-success/10 text-carbon-success text-white", icon: <CheckCircle2 size={14} /> };
 ...
 globalStatus = { text: "ضغط توصيل", color: "bg-carbon-warning/10 text-carbon-warning text-white", icon: <Activity size={14} /> };
 }
 ...
 <div className="bg-carbon-blue/10 text-carbon-blue text-white px-2 py-1 border-carbon-border flex gap-1 items-center">
 <Truck size={10} /> طلبات نشطة: {deliveryOrders.length}
 </div>
 <div className="bg-carbon-success/10 text-carbon-success text-white px-2 py-1 border-carbon-border flex gap-1 items-center">
 <User size={10} /> متاح: {availableDrivers.length}
 </div>
 <div className="bg-carbon-warning/10 text-carbon-warning text-white px-2 py-1 border-carbon-border flex gap-1 items-center">
 <MapPin size={10} /> في مهمة: {busyDrivers.length}
 </div>
 <div className={`${avgWaitTime > 15 ? 'bg-carbon-error text-white animate-pulse' : 'bg-carbon-layerHover text-carbon-text'} px-2 py-1 border-carbon-border flex gap-1 items-center`}>
 ...
 <select 
 className="border-carbon-border rounded-none px-2 py-1 text-[11px] font-medium focus:outline-none focus:bg-carbon-layer"
 value={deliveryType}
 onChange={(e) => {
 ...
 <select
 className="border-carbon-border rounded-none px-2 py-1 text-[11px] font-medium focus:outline-none focus:bg-carbon-layer disabled:opacity-50 disabled:bg-carbon-bg"
 ...
 {/* Column 1: In Kitchen */}
 <div className="flex-1 bg-carbon-layerHover/50 border-carbon-border p-1.5 min-w-[200px] flex flex-col gap-2 relative">
 ...
 key={order.id} 
 className="bg-carbon-layer border-carbon-border p-2 shadow-sm"
 >
 ...
 <span className="text-[10px] font-medium text-carbon-textSecondary bg-carbon-bg px-1 border-carbon-border">{mins}د</span>
 </div>
 <p className="text-[10px] font-medium text-carbon-textSecondary truncate pl-6">{order.customerName}</p>
 {order.isExternalDelivery ? (
 <p className="text-[9px] font-medium text-carbon-warning bg-carbon-warning/10 text-carbon-warning/10 px-1 mt-0.5 inline-block border-carbon-blue/30">
 توصيل خارجي{order.externalCompanyName ? ` - ${order.externalCompanyName}` : ''}
 </p>
 ) : (
 <p className="text-[9px] font-medium text-carbon-success bg-carbon-success/10 text-carbon-success/10 px-1 mt-0.5 inline-block border-carbon-success/30">
 توصيل داخلي
 </p>
 )}
 ...
 <div className="flex-1 bg-carbon-layer/10 border-carbon-warning/50 p-1.5 min-w-[200px] flex flex-col gap-2 relative">
 <div className="sticky top-0 z-10 bg-carbon-layer text-carbon-text border-b-2 border-carbon-warning py-1 text-center shadow-sm">
 ...
 let cardBg = isCritical ? 'bg-carbon-error text-white border-carbon-border shadow-sm' : 'bg-carbon-layer border-carbon-blue ';
 ...
 exit={{ opacity: 0, scale: 0.9 }}
 key={order.id} 
 className={`border p-2 relative ${cardBg}`}
 >
 ...
 <span className={`text-[10px] font-medium px-1.5 py-0.5 border flex items-center gap-0.5 shrink-0 ${isCritical ? 'bg-black border-carbon-border text-white animate-pulse' : 'bg-carbon-warning/10 text-carbon-warning border-carbon-blue text-white'}`}>
 ...
 <div className="mt-2">
 {order.isExternalDelivery ? (
 <div className="w-full bg-carbon-warning/10 text-carbon-warning text-white py-1.5 text-[11px] font-medium shadow-sm flex justify-center items-center gap-1 uppercase">
 توصيل خارجي{order.externalCompanyName ? ` - ${order.externalCompanyName}` : ''}
 </div>
 ) : assigningOrderId === order.id ? (
 <div className="bg-carbon-layer text-carbon-text border-carbon-border p-1 shadow-sm w-full mb-1">
 ...
 availableDrivers.map(d => (
  ...
  className="w-full text-right p-1.5 text-[11px] font-medium hover:bg-carbon-success/10 text-carbon-success hover:text-white border-b border-gray-100 last:border-0 flex justify-between items-center transition-colors"
  >
 ...
 <button onClick={() => setAssigningOrderId(null)} className="w-full text-center bg-carbon-bg text-[10px] font-medium py-1.5 mt-1 hover:bg-carbon-layerHover">إلغاء</button>
 </div>
 ) : (
 <button 
 onClick={() => setAssigningOrderId(order.id)}
 className="w-full bg-carbon-blue/10 text-carbon-blue text-white py-1.5 text-[11px] font-medium border-carbon-border shadow-sm hover:bg-carbon-layer hover:text-carbon-text active:translate-y-px active:shadow-none transition-all flex justify-center items-center gap-1 uppercase"
 >
 <Truck size={12} /> تعيين
 </button>
 )}
 ...
 <div className="flex-1 bg-carbon-blue/10 text-carbon-blue/5 border-brand-blue/30 p-1.5 min-w-[200px] flex flex-col gap-2 relative">
 <div className="sticky top-0 z-10 bg-carbon-blue/10 text-carbon-blue text-white border-b-2 border-brand-blue py-1 text-center shadow-sm">
 <h2 className="font-medium text-[11px] flex items-center justify-center gap-1">
 ...
 exit={{ opacity: 0, scale: 0.9 }}
 key={order.id} 
 className="bg-carbon-blue/10 text-carbon-blue text-white border-carbon-border p-2 shadow-sm"
 >
 ...
 <div className="bg-carbon-layer text-carbon-text px-1.5 py-1 border-carbon-border flex items-center gap-1">
 <div className="w-4 h-4 bg-carbon-blue/10 text-carbon-blue flex items-center justify-center shrink-0">
 ...
 {/* Column 4: Completed */}
 <div className="flex-1 bg-carbon-success/10 text-carbon-success/5 border-carbon-success/30 p-1.5 min-w-[200px] flex flex-col gap-2 relative">
 ...
 exit={{ opacity: 0, scale: 0.9 }}
 key={order.id} 
 className="bg-carbon-success/10 text-carbon-success/10 text-carbon-success border-carbon-success/50 p-2 shadow-sm opacity-80"
 >
 <div className="flex justify-between items-center mb-1">
 <span className="font-medium text-base leading-none">#{order.orderNumber}</span>
 ...
 <div className="w-full lg:w-48 bg-carbon-layer border-carbon-border shadow-sm p-2 flex flex-col shrink-0">
 <h2 className="text-[11px] font-medium mb-2 flex items-center justify-between border-b border-carbon-border pb-1">
 <span>أسطول التوصيل</span>
 <span className="bg-carbon-bg px-1.5 text-[9px] border-carbon-border">{drivers.length}</span>
 </h2>
 ...
 {availableDrivers.map(d => (
 <div key={d.id} className="flex items-center gap-1.5 p-1 hover:bg-carbon-success/10 text-carbon-success/5 text-[10px] font-medium">
 <span className="w-1.5 h-1.5 bg-carbon-success/10 text-carbon-success rounded-full shrink-0"></span>
 <span className="truncate">{d.fullName}</span>
 </div>
 ))}
 </div>
 ...
 return (
 <div key={d.id} className="flex flex-col gap-0.5 p-1 bg-carbon-bg border-gray-100">
 <div className="flex items-center justify-between text-[10px] font-medium text-carbon-text">
 <span className="truncate">{d.fullName}</span>
 <span className="text-[8px] bg-carbon-warning/10 text-carbon-warning text-white px-1">{myOrders.length} طلب</span>
 </div>
 ...
 className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-black text-white p-3 border-carbon-warning z-50 flex flex-col sm:flex-row items-center gap-4 max-w-2xl w-[90%]"
 >
 ...
 <select 
 className="w-full bg-carbon-layer text-black border-white p-2 text-lg font-medium cursor-pointer focus:outline-none focus:border-carbon-warning transition-colors"
 onChange={(e) => {
