...
export default function BranchesCard() {
 ...
 if (loading) return <div className="bg-carbon-layer border-carbon-border p-5 animate-pulse">جاري تحميل الفروع...</div>;
 ...
 <div
 key={branch.id}
 className="p-3 rounded-sm border-carbon-border hover:bg-carbon-layerHover transition-colors"
 >
 ...
 branch.status === "Open" || branch.status === "مفتوح" ? "bg-carbon-success/10 text-carbon-success" : "bg-carbon-error text-white"
 }`}
 >
 ...
 <div className="text-center p-2 bg-carbon-bg rounded-sm border-carbon-border">
