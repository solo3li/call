...
function getStatusStyle(status: string) {
  switch (status) {
    case "Completed":
    case "مكتمل":
      return "bg-[#defbe6] text-[#198038]"; // Green 10 / Green 60
    case "Delivering":
    case "جاري التوصيل":
      return "bg-[#edf5ff] text-[#0f62fe]"; // Blue 10 / Blue 60
    case "Preparing":
    case "جاري التحضير":
      return "bg-[#fff1f1] text-[#da1e28]"; // Red 10 / Red 60
    case "Pending":
    case "قيد الانتظار":
      return "bg-[#fcf4d6] text-[#b47a00]"; // Yellow 10 / Yellow 60
    default:
...
function getTypeStyle(type: string) {
  switch (type) {
    case "DineIn":
    case "صالة":
      return "bg-[#edf5ff] text-[#0f62fe]";
    case "Delivery":
    case "توصيل":
      return "bg-[#f4f4f4] text-[#161616]";
    case "Takeaway":
    case "سفري":
      return "bg-[#e8daff] text-[#6929c4]";
    default:
