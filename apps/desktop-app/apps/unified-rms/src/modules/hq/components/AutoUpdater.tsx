...
export default function AutoUpdater() {
 ...
 >
 {isCheckingManual && (
 <div className="flex items-center gap-3 p-4 shadow-sm rounded-sm border-blue-200 bg-blue-50 text-blue-800 dark:bg-blue-900/30 dark:border-blue-800 w-72">
 ...
 {statusMessage && (
 <div className={`flex items-center justify-between p-4 shadow-sm rounded-sm border w-72 ${
 ...
 <div className="shadow-sm rounded-sm border-carbon-border bg-carbon-layer dark:bg-gray-800 dark:border-gray-700 overflow-hidden w-72">
 <div className="p-4 flex flex-col gap-2">
 <div className="flex justify-between items-start">
 <h3 className="text-sm font-bold text-carbon-text dark:text-white flex items-center gap-2">
