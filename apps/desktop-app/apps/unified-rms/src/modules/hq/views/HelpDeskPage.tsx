...
export default function HelpDeskPage() {
 ...
 {replyTarget && (
 <div className={`mb-1 p-2 rounded-none border-carbon-border text-[10px] font-medium bg-carbon-layer/50 ${isMe ? 'mr-2' : 'ml-2'}`}>
 ...
 <div>
 <img src={msg.attachmentUrl} alt="attachment" className="rounded-none border-carbon-border mb-2 max-h-48 object-cover " />
 {msg.text && <div className="font-medium">{msg.text}</div>}
 </div>
 )}
 {msg.messageType === 'Video' && (
 <div>
 <video src={msg.attachmentUrl} controls className="rounded-none border-carbon-border mb-2 max-h-48 w-full " />
 {msg.text && <div className="font-medium">{msg.text}</div>}
 </div>
 )}
 ...
 <a href={msg.attachmentUrl} target="_blank" rel="noreferrer" className="flex items-center gap-2 bg-carbon-layerHover p-2 rounded-none border-carbon-border hover: transition ">
 ...
 className={`absolute top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-all p-1.5 rounded-none bg-carbon-layer border-carbon-border hover: text-carbon-text ${isMe ? '-left-10' : '-right-10'}`}
 >
 ...
 <div className="bg-carbon-layer border-carbon-border bg-carbon-layer border-b border-carbon-border p-3 flex flex-row items-center justify-between ">
 ...
 className="flex items-center gap-1 bg-carbon-blue text-carbon-text font-semibold text-[10px] px-2 py-1 border-carbon-border shadow-sm hover:shadow-none transition-all uppercase"
 >
 ...
 className="bg-carbon-layer border-carbon-border p-2 shadow-sm hover:bg-carbon-layerHover transition-all cursor-pointer flex flex-col gap-1"
 >
 <div className="flex justify-between items-start gap-1">
 <h4 className="font-semibold text-[10px] text-carbon-text line-clamp-1">{ticket.title}</h4>
 <span className={`text-[8px] font-semibold uppercase px-1 border-carbon-border ${ticket.status === 'Open' ? 'bg-carbon-blue text-carbon-text' : 'bg-[#1A1A1A] text-white'}`}>
 {ticket.status}
 </span>
 </div>
 <p className="text-[9px] font-medium text-carbon-text line-clamp-1 bg-carbon-bg p-1 border-carbon-border/20">
 {ticket.lastMessage}
 </p>
 <div className="flex justify-between items-center text-[8px] font-semibold text-carbon-text pt-1 border-t border-carbon-border/10">
 ...
 <form onSubmit={handleCreateTicket} className="flex-1 overflow-y-auto p-4 flex flex-col gap-4 bg-carbon-layer">
 ...
 Status: <span className={`px-1 rounded-none text-[8px] font-semibold uppercase border-carbon-border ${activeTicketStatus === 'Open' ? 'bg-carbon-blue text-carbon-text' : 'bg-[#1A1A1A] text-white'}`}>{activeTicketStatus}</span>
 </p>
 </div>
 </div>
 </div>
 ...
 <div className="flex flex-col border-carbon-border bg-carbon-layer/20 p-1 rounded-none pl-2">
 ...
 <div className="bg-carbon-layer p-2 border-t border-carbon-border relative">
 {isRecording ? (
 <div className="flex items-center justify-between w-full h-8 bg-carbon-bg border-carbon-border px-1 shadow-sm">
 <button 
 aria-label="Discard recording"
 onClick={() => stopRecording(false)} 
 className="p-1 text-carbon-text hover:bg-carbon-error/100 hover:text-white transition"
 >
 ...
 className="p-1 bg-carbon-blue text-carbon-text border-carbon-border shadow-sm transition"
 >
 ...
 className="p-1 text-carbon-text bg-carbon-layerHover border-carbon-border shadow-sm transition flex-shrink-0"
 >
 ...
 className="p-1 text-carbon-text bg-carbon-layer border-b border-carbon-border shadow-sm transition flex-shrink-0"
 >
 ...
 placeholder="Type..."
 className="flex-1 max-h-24 min-h-[32px] bg-carbon-layer border-carbon-border px-2 py-1 text-[10px] font-medium shadow-sm outline-none resize-none"
 rows={1}
 />
 ...
 className="p-1 bg-carbon-layer border-b border-carbon-border text-carbon-text border-carbon-border shadow-sm disabled:opacity-50 transition-all flex-shrink-0"
 >
