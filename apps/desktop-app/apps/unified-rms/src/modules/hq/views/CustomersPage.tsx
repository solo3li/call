...
export default function CustomersPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {!selectedCustomer && (<div className="bg-carbon-layer border border-carbon-border p-0 overflow-hidden">
              ...
              filteredCustomers.map((customer) => (
                <tr key={customer.id} onClick={() => handleCustomerClick(customer)} className="hover:bg-carbon-layerHover text-carbon-text transition-colors cursor-pointer">
                  ...
                  <td className="px-1 py-1.5 align-middle text-center">
                    <button onClick={(e) => { e.stopPropagation(); handleDelete(customer.id); }} className="p-1 bg-carbon-error/10 text-carbon-error border border-brand-red/30 shadow-sm hover:translate-y-px transition-all">
